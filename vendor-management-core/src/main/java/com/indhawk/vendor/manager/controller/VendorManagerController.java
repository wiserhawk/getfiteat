package com.indhawk.vendor.manager.controller;
...
import com.indhawk.vendor.manager.facade.VendorManagerFacade;
...
import com.indhawk.vendor.manager.validator.VendorRequestValidator;
...
public class VendorManagerController {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="/vendor-manager/getAllVendorsDetails", method=RequestMethod.GET)
	public ResponseEntity<Object> getAllVendorsDeatails() {
		...
		LOG.info("URL /vendor-manager/getAllVendorsDetails time taken = {}", (endTime - startTime));
		respnose = new ResponseEntity<Object>(result, HttpStatus.OK);
		return respnose;
	}
	
	@CrossOrigin(origins="*")
	@RequestMapping(value="/vendor-manager/getAllActiveVendorsDetails", method=RequestMethod.GET)
	public ResponseEntity<Object> getAllActiveVendorsDeatails() {
		...
		long endTime = System.currentTimeMillis();
		LOG.info("URL /vendor-manager/getAllActiveVendorsDetails time taken = {}", (endTime - startTime));
		respnose = new ResponseEntity<Object>(result, HttpStatus.OK);
		return respnose;
	}
	
	@CrossOrigin(origins="*")
	@RequestMapping(value="/vendor-manager/VendorAccount/create", method=RequestMethod.POST)
	public ResponseEntity<Object> createVendor(@RequestBody VendorRequest request) {
		...
		if (vendorRequestValidator.validate(request)) {
			...
			long endTime = System.currentTimeMillis();
			LOG.info("URL /vendor-manager/VendorAccount/create time taken = {}", (endTime - startTime));
			respnose = new ResponseEntity<Object>(result, HttpStatus.OK);
		} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "/vendor-manager/vendorDetailByEmail/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getVendorDetailByEmail(String email) {
		try {
			if (!StringUtils.isEmpty(email)) {
				...
				LOG.info("URL /vendor-manager/vendorDetailByEmail/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "/vendor-manager/vendorDetailByPhone/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getVendorDetailByPhone(String phone) {
		try {
			if (!StringUtils.isEmpty(phone)) {
				...
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(userInfo, HttpStatus.OK);
				LOG.info("URL /vendor-manager/vendorDetailByPhone/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "/vendor-manager/vendorDetailByVendorId/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getVendorDetailByVendorId(String vendorId) {
		try {
			if (!StringUtils.isEmpty(vendorId)) {
				...
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(userInfo, HttpStatus.OK);
				LOG.info("URL /vendor-manager/vendorDetailByVendorId/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "/vendor-manager/authenticate", method = RequestMethod.POST)
	public ResponseEntity<Object> authenticateVendor(String identifier, String password) {
		try {
			if (!StringUtils.isEmpty(identifier) && !StringUtils.isEmpty(password) ) {
				...
				LOG.info("URL /vendor-manager/authenticate time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "/vendor-manager/getVendorOrders", method = RequestMethod.POST)
