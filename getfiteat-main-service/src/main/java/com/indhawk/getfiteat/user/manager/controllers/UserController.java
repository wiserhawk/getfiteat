package com.indhawk.getfiteat.user.manager.controllers;
...
import com.indhawk.getfiteat.user.manager.facade.AddressManagerFacade;
import com.indhawk.getfiteat.user.manager.facade.UserManagerFacade;
import com.indhawk.getfiteat.user.manager.request.AddressRequest;
import com.indhawk.getfiteat.user.manager.request.LoginRequest;
import com.indhawk.getfiteat.user.manager.request.UserDetailRequest;
import com.indhawk.getfiteat.user.manager.response.AddressResponse;
import com.indhawk.getfiteat.user.manager.response.UserAuthResponse;
import com.indhawk.getfiteat.user.manager.response.UserDetailResponse;
import com.indhawk.getfiteat.user.manager.validator.AddressRequestValidator;
import com.indhawk.getfiteat.user.manager.validator.RequestValidator;
...
public class UserController {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/userAccount/create", method = RequestMethod.POST)
	public ResponseEntity<Object> createUserAccount(@RequestBody UserDetailRequest request) {
		...
		try {
			...
			LOG.info("URL gfe-main/user-manager/userAccount/create time taken = {}", (endTime - startTime));
			return respnose;
		} catch(Exception e) {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/userDetailByEmail/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getUserDetailByEmail(@RequestBody String email) {
		try {
			if (!StringUtils.isEmpty(email)) {
				...
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(userInfo, HttpStatus.OK);
				LOG.info("URL gfe-main/user-manager/userDetailByEmail/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/userDetailByPhone/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getUserDetailByPhone(@RequestBody String phone) {
		try {
			if (!StringUtils.isEmpty(phone)) {
				...
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(userInfo, HttpStatus.OK);
				LOG.info("URL gfe-main/user-manager/userDetailByPhone/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/userDetailByUserId/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getUserDetailByUserId(@RequestBody String userId) {
		try {
			if (!StringUtils.isEmpty(userId)) {
				...
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(userInfo, HttpStatus.OK);
				LOG.info("URL gfe-main/user-manager/userDetailByUserId/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/userAddress/create", method = RequestMethod.POST)
	public ResponseEntity<Object> createUserAddress(@RequestBody AddressRequest address) {
		...
		try {
			...
			LOG.info("URL gfe-main/user-manager/userAddress/create time taken = {}", (endTime - startTime));
			return respnose;
		} catch(Exception e) {
			LOG.error(e.getMessage());
			ResponseEntity<Object> errorRespnose = new ResponseEntity<Object>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/addressDetailsByUserId/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getAddressDetailsByUserId(@RequestBody String userId) {
		try {
			if (!StringUtils.isEmpty(userId)) {
				long startTime = System.currentTimeMillis();
				...
				LOG.info("URL gfe-main/user-manager/addressDetailsByUserId/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
				LOG.error("ERROR: Input UserID is not available. UserId={}", userId);
				ResponseEntity<Object> errorRespnose = new ResponseEntity<Object>("User ID parameter is either null or empty.", HttpStatus.BAD_REQUEST);
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/addressDetailsByAddressNumber/get", method = RequestMethod.POST)
	public ResponseEntity<Object> getAddressDetailByAddressNumber(@RequestBody String addressNumber) {
		try {
			if (!StringUtils.isEmpty(addressNumber)) {
				...
				LOG.info("URL gfe-main/user-manager/addressDetailsByAddressNumber/get time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/authenticate", method = RequestMethod.POST)
	public ResponseEntity<Object> authenticateUser(@RequestBody LoginRequest loginRequest) {
		try {
			if (!StringUtils.isEmpty(loginRequest.getIdentifier()) && !StringUtils.isEmpty(loginRequest.getPassword()) ) {
				long startTime = System.currentTimeMillis();
				UserAuthResponse authResponse = userManagerFacade.authenticate(loginRequest.getIdentifier(), loginRequest.getPassword());
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(authResponse, HttpStatus.OK);
				LOG.info("URL gfe-main/user-manager/authenticate time taken = {}", (endTime - startTime));
				return respnose;
			} else {
				LOG.error("ERROR: Input identifier / password is not available. identifier={}, is_password_empty={}", loginRequest.getIdentifier(), StringUtils.isEmpty(loginRequest.getPassword()));
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/sendVerificationCodeOnEmail", method = RequestMethod.POST)
	public ResponseEntity<Object> sendVerificationCodeOnEmail(@RequestBody String email) {
		try {
			if (!StringUtils.isEmpty(email)) {
				long startTime = System.currentTimeMillis();
				...
				LOG.info("URL gfe-main/user-manager/sendVerificationCodeOnEmail time taken = {}", (endTime - startTime));
				return respnose;
			} else {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/user-manager/resetUserPassword", method = RequestMethod.POST)
	public ResponseEntity<Object> resetUserPassword(String email, String password, String verificationCode) {
		try {
			if (!StringUtils.isEmpty(email) && !StringUtils.isEmpty(password) && !StringUtils.isEmpty(verificationCode)) {
				...
				long endTime = System.currentTimeMillis();
				ResponseEntity<Object> respnose = new ResponseEntity<Object>(message, HttpStatus.OK);
				LOG.info("URL gfe-main/user-manager/resetUserPassword time taken = {}", (endTime - startTime));
				return respnose;
			} else {
