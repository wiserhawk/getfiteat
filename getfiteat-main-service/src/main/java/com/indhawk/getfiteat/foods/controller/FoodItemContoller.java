package com.indhawk.getfiteat.foods.controller;
...
import com.indhawk.getfiteat.foods.facade.FoodServiceFacade;
import com.indhawk.getfiteat.foods.request.FoodItemRequest;
import com.indhawk.getfiteat.foods.request.validator.RequestValidator;
import com.indhawk.getfiteat.foods.response.FoodItemResponse;
...
public class FoodItemContoller {
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getAllItems", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getAllActiveItems", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getItemById/{id}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getItemsByMenu/{menu}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getItemsFromAndToLimit/{from}/{to}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getItemsFromToDefaultLimit/{from}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getItemsByTypeId/{typeId}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/getItemsByCategoryId/{categoryId}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/save", method = RequestMethod.POST)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/update", method = RequestMethod.POST)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/deleteById/{foodId}", method = RequestMethod.GET)
	 ...
	 */
	@CrossOrigin(origins="*")
	@RequestMapping(value = "gfe-main/foods/items/test", method = RequestMethod.GET)
	public String test() {
