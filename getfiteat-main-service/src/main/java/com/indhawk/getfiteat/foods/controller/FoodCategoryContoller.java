...
import com.indhawk.getfiteat.foods.facade.FoodCategoryServiceFacade;
...
public class FoodCategoryContoller {
	 ...
	 * @return
	 */
	@RequestMapping(value = "gfe-main/foods/category/getAllFoodCategories", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "gfe-main/foods/category/save", method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value = "gfe-main/foods/category/update", method = RequestMethod.PUT)
	 ...
	 * @return
	 */
	@RequestMapping(value = "gfe-main/foods/category/delete/{catId}", method = RequestMethod.DELETE)
