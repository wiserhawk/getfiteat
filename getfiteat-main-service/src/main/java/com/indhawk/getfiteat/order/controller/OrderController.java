package com.indhawk.getfiteat.order.controller;
...
import com.indhawk.getfiteat.order.facade.OrderManagerFacade;
...
import com.indhawk.getfiteat.order.validator.OrderRequestValidator;
import com.indhawk.getfiteat.order.validator.OrderStatusRequestValidator;
import com.indhawk.getfiteat.order.validator.PaymentModeRequestValidator;
...
public class OrderController {
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/createOrder/save", method=RequestMethod.POST)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/orderByPaymentMode/get", method=RequestMethod.POST)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/updateOrderStatus/update", method=RequestMethod.POST)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/orderByOrderId/{orderId}", method=RequestMethod.GET)
	public ResponseEntity<OrderResponse> getOrderByOrderId(@PathVariable String orderId) {
		...
		if (!StringUtils.isEmpty(orderId)) {
			OrderResponse order = orderManagerFacade.getOrderByOrderId(orderId);
			response = new ResponseEntity<OrderResponse>(order, HttpStatus.OK);
			LOG.debug("Response of order by Id. Response={}", order);
		} else {
			response = new ResponseEntity<OrderResponse>(HttpStatus.BAD_REQUEST);
		}
		return response;
	}
	
	/*@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/orderByOrderId/get", method=RequestMethod.POST)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/orderListByOrderIds/get", method=RequestMethod.POST)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allConfirmedOrders/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allShippedOrders/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allDeliveredOrders/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allRejectedOrders/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allFailedOrders/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allPaymentMethodTypes/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allOrdersByVendorId/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allAssignedOrdersByVendorId/get", method=RequestMethod.GET)
	public ResponseEntity<List<OrderModel>> getAllConfirmedOrdersByVendorId(String vendorId) {
		LOG.debug("Request received to get order list of assinged orders.");
		ResponseEntity<List<OrderModel>> orderListResponse = null;
		List<OrderModel> orderList = orderManagerFacade.getAllAssignedOrdersByVendorId(vendorId);
		orderListResponse = new ResponseEntity<List<OrderModel>>(orderList, HttpStatus.OK);
		LOG.debug("Response of order list of assinged orders. Response={}", orderList);
		return orderListResponse;
	}
	
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allShippedOrdersByVendorId/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allDeliveredOrdersByVendorId/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allRejectedOrdersByVendorId/get", method=RequestMethod.GET)
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="gfe-main/order/allFailedOrdersByVendorId/get", method=RequestMethod.GET)
